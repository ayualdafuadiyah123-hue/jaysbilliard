<div class="relative bg-[#141419] border border-white/[0.06] rounded-2xl p-7 overflow-hidden transition-all duration-300 hover:border-cyan-400/30 hover:-translate-y-1 group">
    ...
    <h3 class="text-white font-bold text-lg mb-2"><?php echo e($title); ?></h3>
    
    
    <p class="text-gray-400 text-sm leading-relaxed"><?php echo e($description); ?></p>
</div>
<?php /**PATH C:\laragon\www\jaysbilliard-main\resources\views/component/c_website/feature-card.blade.php ENDPATH**/ ?>