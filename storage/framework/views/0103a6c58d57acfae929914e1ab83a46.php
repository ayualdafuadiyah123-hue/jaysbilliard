    ...
    <div class="relative flex items-center justify-center min-h-screen p-8 md:p-6 sm:p-4">
        ...
        <div class="relative z-10 w-full max-w-md bg-[#0f141e]/85 backdrop-blur-custom border border-primary/15 rounded-2xl p-10 md:p-8 sm:p-7 shadow-2xl">
            ...
            <form action="<?php echo e(route('register')); ?>" method="POST" class="flex flex-col gap-5">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex items-center bg-white/5 border border-primary/20 rounded-xl px-4 transition-all focus-within:border-primary focus-within:shadow-neon-sm">
                        ...
                        <input type="text" name="name" class="flex-1 bg-transparent border-none outline-none text-white text-sm py-3.5 placeholder:text-white/30" placeholder="Masukkan nama lengkap anda" value="<?php echo e(old('name')); ?>" required>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex items-center bg-white/5 border border-primary/20 rounded-xl px-4 transition-all focus-within:border-primary focus-within:shadow-neon-sm">
                        ...
                        <input type="text" name="phone" class="flex-1 bg-transparent border-none outline-none text-white text-sm py-3.5 placeholder:text-white/30" placeholder="Masukkan nomor HP anda" value="<?php echo e(old('phone')); ?>" required>
                    </div>
                </div>
            ...
            <p class="text-center text-sm text-white/50 mt-6">
                Sudah punya akun? <a href="<?php echo e(route('login')); ?>" class="text-primary font-semibold transition-opacity hover:opacity-80">Log in</a>
            </p>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\jaysbilliard-main\resources\views/autentikasi/register.blade.php ENDPATH**/ ?>