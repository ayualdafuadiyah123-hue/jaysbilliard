                            ...
                            <div class="adm-preview-card-wrap">
                                <div class="preview-table-card">
                                    <div class="preview-img-wrap">
                                        <div class="preview-price-badge">Rp <span id="viewPrice"><?php echo e(number_format($table->price_per_hour, 0, ',', '.')); ?></span></div>
                            ...
                            <div class="adm-form-card">
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price_per_hour" id="inpPrice" class="form-input" value="<?php echo e((int)$table->price_per_hour); ?>">
                                    </div>
                                    <div class="form-group">
